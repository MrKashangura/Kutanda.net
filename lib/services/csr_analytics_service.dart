...
class _CSRAnalyticsScreenState extends State<CSRAnalyticsScreen> {
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: int.parse(rating) >= 4 ? Colors.green : 
                                 int.parse(rating) == 3 ? Colors.amber :
                                 Colors.red,
                        ),
                      ),
                    ),
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation<Color>(
                            int.parse(rating) >= 4 ? Colors.green : 
                            int.parse(rating) == 3 ? Colors.amber :
                            Colors.red,
                          ),
                          minHeight: 16,
  ...
  Widget _buildTicketVolumeByHourChart() {
    ...
    int maxVolume = _ticketVolumeByHour.values.fold(0, (max, value) => value > max ? value : max);
                      ...
                      children: List.generate(24, (hour) {
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            // X-axis label
                            hour % 3 == 0 ? Text('${hour.toString().padLeft(2, '0')}:00') : const SizedBox(height: 12),
                          ],
                        );
                      }),
                    ),
